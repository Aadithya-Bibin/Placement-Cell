...
$sql = "Select Email,UserName,Password from Employer_Reg where EmployerId=".$Id."";
...
$body="You company have been registered succsesfully in the placement cell\nThe username is:".$uname."\nThe password is:".$upass;
...
$conn->close();
echo '<script type="text/javascript">alert("Company Request Confirmed");window.location=\'ManageEmployer.php\';</script>';
?>
</body>
</html>
