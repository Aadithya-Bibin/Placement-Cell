...
{
    $qual=$_POST['qual'];
    $sql = "SELECT s.jobSeekerName,s.Qualification, j.CompanyName,j.JobTitle from jobseeker_reg as s, job_master as j,application_master as a where a.JobSeekId=s.JobSeekId and a.JobId=j.JobId and j.CompanyName='".$qual."' ORDER BY JobSeekerName";
// Execute query
$result = $conn->query($sql);
...
{
    $qual=$_POST['cor'];
    $sql = "SELECT s.jobSeekerName,s.Qualification, j.CompanyName,j.JobTitle from jobseeker_reg as s, job_master as j,application_master as a where a.JobSeekId=s.JobSeekId and a.JobId=j.JobId and s.Qualification='".$qual."' ORDER BY JobSeekerName";
// Execute query
$result = $conn->query($sql);
// Loop through each records 
while($row =  $result->fetch_assoc())
...
{
$sql = "SELECT s.jobSeekerName,s.Qualification, j.CompanyName,j.JobTitle from jobseeker_reg as s, job_master as j,application_master as a where a.JobSeekId=s.JobSeekId and a.JobId=j.JobId ORDER BY JobSeekerName";
// Execute query
$result = $conn->query($sql);
// Loop through each records 
while($row =  $result->fetch_assoc())
