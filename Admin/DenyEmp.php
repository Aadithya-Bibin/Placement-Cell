...
$body="You company registeration has been denied.\nContact the regesitration office for more details";
...
$conn->close();
echo '<script type="text/javascript">alert("Company Request Denied");window.location=\'ManageEmployer.php\';</script>';
?>
</body>
</html>
