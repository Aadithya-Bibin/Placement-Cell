...
$sql1 = "Update JobSeeker_Reg set Status='Confirm' where JobSeekId=".$Id."";
// Execute query
$conn->query($sql1);
...
$body="You have been registered succsesfully in the placement cell\nThe username is:".$uname."\nThe password is:".$upass;
...
$conn->close();
echo '<script type="text/javascript">alert("Student Request Confirmed");window.location=\'ManageJob.php\';</script>';
?>
</body>
</html>
