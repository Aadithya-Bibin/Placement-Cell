                ...
                <table width="100%" border="1" cellspacing="4" cellpadding="4">
                  <tr>
                    ...
                    <td><span id="sprytextfield1">
                      <label>
                      <input readonly name="txtId" type="text" id="txtId" value="<?php echo $row['JobSeekId'];?>" />
                      </label>
                  ...
                  <tr>
                    ...
                    <td><span id="sprytextfield3">
                      <label>
                      <input name="txtContact" type="text" id="txtContact" value="<?php echo $row['Address'];?>" />
                      </label>
                    <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><span id="sprytextfield7">
                      <label>
                      <input name="txtArea" type="text" id="txtArea" value="<?php echo $row['Qualification'];?>" />
                      </label>
                    <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                  </tr>
                  <td><strong>Supply:</strong></td>
                    <td><span id="sprytextfield7">
                      <label>
                      <input name="txtSupply" type="text" id="txtSupply" value="<?php echo $row['Supply'];?>" />
                      </label>
                    <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><span id="sprytextfield9">
                      <label>
                      <input name="txtPassword" type="text" id="txtPassword" value="<?php echo $row['Password'];?>" />
                      </label>
                    <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                  </tr>
